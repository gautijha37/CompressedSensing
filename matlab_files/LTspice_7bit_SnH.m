...
clear all
%% netlist path %%
%"C:\Users\gauti\Documents\MATLAB\cmi_7b_SnH.net"
%% .exe path %%
%"C:\Program Files\LTC\LTspiceXVII\scad3.exe"

%% My netlist
netlist = ['C:\Users\gauti\Documents\MATLAB\cmi_7b_SnH.net'];

input_amp = 0.19; % Input sine amp in volt
input_freq = 0.46; % fin = input_freq * fs

data = fileread('netlist_7b_SnH.txt');
...
fileName = 'cmi_7b_SnH.raw';
dos('LTSpice_call_7bit_SnH.bat');
pause(10) ;
