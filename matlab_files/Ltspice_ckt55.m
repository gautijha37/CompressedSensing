...
clear all
%% netlist path %%
%"C:\Users\gauti\Documents\MATLAB\cmi55.net"
%% .exe path %%
%"C:\Program Files\LTC\LTspiceXVII\scad3.exe"

%% My netlist
netlist = ['C:\Users\gauti\OneDrive\Documents\MATLAB\cmi55.net'];

input_amp = 0.2; % Input sine amp in volt
input_freq = 0.23; % fin = input_freq * fs

data = fileread('netlist2.txt');
